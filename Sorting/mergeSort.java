...
public void merge(int low, int middle1, int middle2, int high){
  ...
  System.out.println( "         " + subarray( middle2,high ) );
  System.out.println( "low " + Integer.toString(low) );
  System.out.println( "high " + Integer.toString(high) );
  System.out.println( "middle1 " + Integer.toString(middle1) );
  System.out.println( "middle2 " + Integer.toString(middle2) );
